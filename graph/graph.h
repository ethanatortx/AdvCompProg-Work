...
public:
	...
	template<class E, class Hash_E = std::hash<E>>
	friend bool operator==(const graph_matrix<E, Hash_E>::const_iterator&, const graph_matrix<E, Hash_E>::const_iterator&);
	template<class E, class Hash_E = std::hash<E>>
	friend bool operator!=(const graph_matrix<E, Hash_E>::const_iterator&, const graph_matrix<E, Hash_E>::const_iterator&);
...
template<class T, Hash = std::hash<T>>
